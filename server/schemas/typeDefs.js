...
const typeDefs = gql`
  ...
  type Mutation {
    ...
    addAboutMe(aboutMe: String!): Auth!
    editAboutMe(aboutMe: String!): Auth!
    addAge(age: Int!): Auth!
    editAge(age: Int!): Auth!
    addFavoriteGenre(favoriteGenre: String!): Auth!
    editFavoriteGenre(favoriteGenre: String!): Auth!
